using ThoemusBike.WebApp.Properties;
...
public class CheckoutModel(IProductService productService, IEmailSender emailService) : PageModel
{
    ...
    public async Task OnGetAsync()
    {
        ...
        var cookie = Request.Cookies["thoemusbike-cart"];
    ...
    public async Task<IActionResult> OnPostSubmitOrder()
    {
        ...
        await emailService.SendEmailAsync(EmailAddress, "Your ThoemusBike Order", template);

        Response.Cookies.Delete("thoemusbike-cart");
